...
/*
import { EventData, GroupData } from "../types";
import csrfFetch from "./csrf";
import { ADD_GROUP } from "./groups";
...
export const addEvent = (payload: EventPayload) => ({
...
export const addSearchedEvents = (payload: SearchedEventPayload) => ({
    type: EventActionTypes.ADD_SEARCHED_EVENTS,
    payload
})

export const getanEvent = (eventId: number) => (state) => {
    if(!state.events) return null;
